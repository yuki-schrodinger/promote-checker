var quantumStateMapping = {
  ...
  Alive:
    "a quantum state under the theme 'Alive Cat,' capturing the dynamic energy and playfulness resonating within the quantum realm and bringing the essence of life to the forefront.",
  ...
  Silver:
    "a quantum state resonating with the brilliance of silver, reflecting the essence of both the physical and the quantum.",
  ...
  Water:
    "a quantum state inspired by the element of water, where quantum waves dance in harmony with liquid dynamics.",
  ...
  Earth:
    "a quantum state rooted in the stability and grounded energy of the earth, capturing the essence of solidity and foundation within the quantum realm.",
  ...
  Metal:
    "a quantum state resonating with the strength and conductivity of metal, embodying the fusion of classical durability with quantum complexity.",
  ...
  Lightning:
    "a quantum state charged with the intensity of lightning, symbolizing the sudden and powerful transitions inherent in quantum systems.",
};
...
function _extractHasGroup(traitType, value) {
  var isThisGroup = [
    ...
    "tail",
    "wings",
  ].includes(traitType.toLowerCase().trim());
  if (!isThisGroup) {
    return null;
  }
...
function _extractZodiacGroup(traitType, value) {
  var isThisGroup = ["zodiac", "zodiac sign", "zodiac signs"].includes(
  ...
  var newValue =
    "There is a badge on the top right corner, with the corresponding " +
    value +
    " zodiac image on it.";
...
function _extract(trait_arg) {
  var handlers = [
    _extractQuantumStateGroup,
    _extractRideGroup,
    _extractBreedGroup,
    _extractBackgroundGroup,
    _extractPetGroup,
    _extractIsGroup,
    _extractHasGroup,
    _extractWearingGroup,
    _extractZodiacGroup,
    _extractAccessoryLeftGroup,
    _extractAccessoryRightGroup,
    _extractWeaponLeftGroup,
    _extractWeaponRightGroup,
    _extractWithGroup,
  ];
...
function createPrompt(config, trait_args) {
  ...
  if (groupBreed != "") {
    prompt = prompt.replace(
      /image of a [\w\s]*[Cc]at/,
      "image of a " + groupBreed + " cat"
    );
  }
  ...
  prompt =
    prompt +
    " The image should contain the full-body shot of the main character.";

...
const INNER_SD_API_POOL: string[] = [];

for (let i = 0; i < 4; i++) {
  INNER_SD_API_POOL.push(`${SD_BASE_URL_INNER1}:786${i}/sdapi/v1/txt2img`);
  INNER_SD_API_POOL.push(`${SD_BASE_URL_INNER2}:786${i}/sdapi/v1/txt2img`);
}

export { INNER_SD_API_POOL };
